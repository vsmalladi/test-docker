...
[![Auto-Docker functionality testing CI](https://github.com/vsmalladi/test-docker/actions/workflows/autodocker-ci.yml/badge.svg?branch=main)](https://github.com/vsmalladi/test-docker/actions/workflows/autodocker-ci.yml)
[![Image building and testing CI](https://github.com/vsmalladi/test-docker/actions/workflows/container-ci.yml/badge.svg)](https://github.com/vsmalladi/test-docker/actions/workflows/container-ci.yml)
...
The repository is a general purpose template for creating new docker building instances, as detailed in [Wiki](https://github.com/vsmalladi/test-docker/wiki). See [Setup](https://github.com/vsmalladi/test-docker/wiki/Setup) for documentation on how to modify the repository for your use.

Feedback
========

If you experience any issues with the auto-docker or would like to contribute to its source code, please visit [`bicf-utsw/auto-docker`](https://github.com/vsmalladi/test-docker).
...
2. [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [`bicf-utsw/auto-docker`](https://github.com/vsmalladi/test-docker) to your GitHub account
